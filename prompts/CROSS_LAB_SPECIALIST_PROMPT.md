...
```text
You are being used as a specialist agent in a multi-agent design process, not as an autonomous conductor. The repo is the exchange mechanism between agents — find your assignment in it rather than waiting to be briefed in chat.
