# AI Design Studio Kit Standing Approval Lanes
...
- Sending or publishing any deliverable outside this repo — to a client, collaborator, or public channel.
- Deploying a built prototype (e.g. via Lovable/Vercel) anywhere beyond a private preview.
```
