...
This folder turns the six frozen directions in `../004-directions.md` plus the Handoff 007 challenger and the four additive place modes in `../006-place-mode.md` into inspectable laptop-first review plates. GitHub is the source of truth.
